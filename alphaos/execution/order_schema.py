...
def build_order_row(
    *,
    ...
    return {
        ...
        "risk_check_id": getattr(proposal, "risk_check_id", None),
        "order_class": "bracket" if order_type == "bracket" else "simple",
        "intended_entry_price": getattr(proposal, "entry", None),
